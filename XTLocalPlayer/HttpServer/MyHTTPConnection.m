...
- (void) processStartOfPartWithHeader:(MultipartMessageHeader*) header {
	...
	NSString* uploadDirPath = [File_PATH stringByAppendingPathComponent:@"upload"];
    ...
    if( [[NSFileManager defaultManager] fileExistsAtPath:filePath] ) {
        ...
        NSError *err_0 = nil;
        [[NSFileManager defaultManager] createDirectoryAtPath:uploadDirPath withIntermediateDirectories:true attributes:nil error:&err_0];
		if(err_0) {
			CLog(@"===>error_0： %@", err_0.localizedDescription);
		}
        ...
        NSString *fileRelativePath = [NSString stringWithFormat:@"/upload/%@", filename];
		[uploadedFiles addObject:fileRelativePath];
        
        FileModel *model = [[FileModel alloc] initWithName:filename andPath:fileRelativePath];
